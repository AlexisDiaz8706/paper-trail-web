...
This repository is the frontend only. The backend API ([paper-trail-api](https://github.com/Operation-Hope/paper-trail-api)) is under active development.

When working on features that require API integration:

1. Check the backend repository for current API status
2. Document expected API requirements in the PR
3. The frontend can be explored without a running backend
4. Use proper TypeScript types for API responses (see `src/types/api.ts`)
