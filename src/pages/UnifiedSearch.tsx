...
export default function UnifiedSearch() {
  ...
  const handlePoliticianSearch = async (e?: React.FormEvent) => {
    ...
    if (politicianInput.length >= 2) {
      ...
      void navigateToSearch('politician');
    }
  };
  ...
  const handleClearComparison = () => {
    clearComparison();
    void navigateToSearch('politician', politicianQuery || undefined);
  };
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <TabsContent value="politician" className="mt-0">
              ...
              <form onSubmit={(e) => void handlePoliticianSearch(e)} className="flex gap-2">
                <Input
                  type="text"
            ...
            <TabsContent value="donor" className="mt-0">
              ...
              <form onSubmit={(e) => void handleDonorSearch(e)} className="flex gap-2">
                <Input
                  type="text"
